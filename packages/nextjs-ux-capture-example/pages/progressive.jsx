	...
	<Layout>
		<View {...progressiveZones}>
				...
				<Lazy
					...
					fallback={
						<React.Fragment>
							...
							<UXCaptureInlineMark
								mark={PROGRESSIVE_PRIMARY_BUTTON_DISPLAYED}
							/>
						</React.Fragment>
					}
				>
					<UXCaptureInteractiveMark
						mark={PROGRESSIVE_PRIMARY_BUTTON_INTERACTIVE}
					>
						<button
							className="button"
							style={getBoxStyle('ux-primary-action-available')}
							onClick={() =>
								alert('Progressive enhancement is the best!')
							}
						>
							Primary action button
						</button>
			...
			<Lazy delay={1500}>
				...
				<div className="chunk">
					<p>
						The Restum ipsum dolor sit amet, consectetur adipiscing elit,
