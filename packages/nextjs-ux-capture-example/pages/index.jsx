...
class Basic extends React.Component {
	...
	render() {
		return (
			<Layout>
				<Head>
					<title>Basic View | UX Capture NextJS example</title>
					<link rel="icon" href="/favicon.ico" key="icon" />
				</Head>
				<View {...basicZones}>
					<div
						className="chunk"
						style={getBoxStyle('ux-primary-content-displayed')}
					>
						<UXCaptureImageLoad
					...
					<div className="chunk">
						<div style={getBoxStyle('ux-primary-content-displayed')}>
							...
							<p>
								All content in this view is loaded synchronously, but
								click action for the button still takes time to
								attach.
							</p>
							<p>
								This view also has no title so transitioning here from
								another view immediately satisfies{' '}
								<code>ux-destination-verified</code> zone because logo
								is always there, recording a UserTiming with{' '}
						...
						<Lazy
							...
							fallback={
								<React.Fragment>
									...
									<UXCaptureInlineMark
										mark={BASIC_PRIMARY_BUTTON_DISPLAYED}
									/>
								</React.Fragment>
							}
						>
							<UXCaptureInteractiveMark
								mark={BASIC_PRIMARY_BUTTON_INTERACTIVE}
							>
								<button
									className="button"
					...
					<div className="chunk">
						<p>
							The Restum ipsum dolor sit amet, consectetur adipiscing
