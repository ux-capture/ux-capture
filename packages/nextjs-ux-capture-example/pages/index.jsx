		...
		<View {...basicZones}>
			...
			<div className="chunk">
				<div style={getBoxStyle('ux-primary-content-displayed')}>
					...
					<p>
						All content in this view is loaded synchronously, but click
						action for the button still takes time to attach.
					</p>
					<p>
						This view also has no title so transitioning here from another
						view immediately satisfies{' '}
						<code>ux-destination-verified</code> zone because logo is
						always there, recording a UserTiming with <code>0ms</code>{' '}
						duration.
					</p>
				</div>
